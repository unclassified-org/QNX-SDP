...
<Client|Server>
	...
	<!--
		...
		Allowed values:
			...
			ALLOW_UPDATE                    allow client to change object properties
                                                        even if restricted flag set to 1 (e.g. TMM to update ratings)
			...
			moov_not_supported	does not support rendering of mp4/3gp files
								with moov box at the end of file
