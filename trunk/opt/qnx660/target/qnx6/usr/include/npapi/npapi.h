...
#if defined(__QNXNTO__) && defined(_UINT32)
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/npapi/public/npapi/npapi.h $ $Rev: 680336 $")
#endif
