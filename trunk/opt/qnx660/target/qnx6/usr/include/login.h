...
extern int	pbkdf2(const unsigned char *__pw, size_t __pwlen, const unsigned char *__salt, size_t __saltlen, unsigned char *__key, size_t __keylen, unsigned int __ks);
...
extern int		set_ids_from_arg(const char* arg);
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/patch/password_hash/lib/login/public/login.h $ $Rev: 795515 $")
#endif
