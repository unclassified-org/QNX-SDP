...
LD_LIBRARY_PATH="/proc/boot:${IFS2_LOC}/lib:${IFS2_LOC}/lib/dll:${IFS2_LOC}/usr/lib:${BASEFS?}/usr/lib:${BASEFS?}/lib/dll:${BASEFS?}/lib:${BASEFS?}/lib/dll/font:/lib:/usr/lib:/lib/dll:/opt/lib:${BASEFS?}/usr/photon/lib:${BASEFS?}/qt5-5.2/lib:/qtcar/lib:${WEBKIT_ROOT?}"
