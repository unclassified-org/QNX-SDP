...
webview =
    ...
    create: function (ready) {
        _webviewObj = window.qnx.webplatform.createWebView({processId: IN_PROCESS, defaultSendEventHandlers: ['onChooseFile', 'onOpenWindow'], defaultWebEventHandlers: ['InvokeRequestEvent']}, function () {
