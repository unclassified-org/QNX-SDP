 ...
 *}</code></pre></dd></dl>
 * 
 * @module qnx_xyz_bluetooth_xyz_pbap
 */
 
 /*
 * @author lgreenway@qnx.com
 * $Id: client.js 4726 2012-10-24 15:55:42Z lgreenway@qnx.com $
 */
...
module.exports = {
	...
	find: function(filter, orderBy, isAscending, limit, offset) {
		...
		for(var result in results) {
			contacts.push(new Contact(results[result]));
		}
	 ...
	 */
	refresh: function() {
		window.webworks.execAsync(_ID, 'refresh');
	}
};